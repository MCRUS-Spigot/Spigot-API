...
public class ClearCommand extends VanillaCommand {
    ...
    public boolean execute(CommandSender sender, String currentAlias, String[] args) {
        ...
        if (player != null) {
            ...
            Command.broadcastCommandMessage(sender, "Инвентарь игрока " + player.getDisplayName() + " очищен, удалено " + count + " "+StringUtil.plural(count, "Удален", "Удалены", "Удалено") + " " + count + " " + StringUtil.plural(count, "предмет", "предмета", "предметов"));
